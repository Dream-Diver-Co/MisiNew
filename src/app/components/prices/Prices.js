          ...
          <div className="col-md-10 offset-md-1 mt-5">
            ...
            <div className="prices-row prices-row-1 row text-center mb-5" style={{ height: match ? '900px' : '1450px' }}>
              ...
              {services.map((service, index) => (
                <div key={service.name} data-aos={index % 2 == 0 ? "zoom-in-down" : "zoom-in-up"} data-aos-duration="1000" className="col-6 col-md-4 mb-3 cats" style={{width:'25vw'}}>
                  <div className=" catsContent" style={{ height: '100%' }}>
                    <div className='rounded-5 frontSide'>
                      <div style={{ height: '250px' }}>
                        <img src={service.image} style={{ width: '500px', height: '100%' }} alt="1.png" />
                      </div>
